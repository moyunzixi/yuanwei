...
LS.shadows = {
  ...
  records: [
...

    {
      ...
      cond: {
        any: [
          { flag: 'kept_zhouran_number' },
          { flag: 'called_zhouran' },
          { npc: 'zhouran.affection', op: '>=', value: 30 }
        ]
      },
      sent: ['收到了吗？'],
      steps: [
        { k: 'input', text: '那张票我留了两年。' },
        { k: 'pause' },
        { k: 'input', text: '每次搬家都想扔。' },
        { k: 'pause' },
        { k: 'input', text: '最后还是放进去了。' },
        { k: 'delete' },
        { k: 'input', text: '算了。' },
        { k: 'send', text: '收到了吗？' }
      ],
...

    {
      ...
      cond: {
        any: [
          { flag: 'heard_shenyan_story' },
          { npc: 'shenyan.affection', op: '>=', value: 30 }
        ]
      },
      sent: ['不早了。'],
      steps: [
        { k: 'input', text: '其实我很少跟人说这些。' },
        { k: 'delete' },
        { k: 'input', text: '我也不知道为什么告诉了你。' },
        { k: 'delete' },
        { k: 'input', text: '大概是……' },
        { k: 'pause' },
        { k: 'input', text: '算了。' },
...

    {
      ...
      cond: {
        any: [
          { flag: 'voice_call_linwan' },
          { npc: 'linwan.affection', op: '>=', value: 40 }
        ]
      },
      sent: ['晚安。'],
      steps: [
        { k: 'input', text: '电话挂断以后，我又把手机拿了回来。' },
        { k: 'input', text: '你刚才那句"我在听"——' },
        { k: 'pause' },
        { k: 'input', text: '我已经很久没有听过了。' },
        { k: 'delete' },
        { k: 'input', text: '算了。' },
        { k: 'delete' },
        { k: 'nosend' }
